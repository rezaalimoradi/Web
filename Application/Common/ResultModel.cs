...
namespace Application.Common
{
    ...
    {
        public static ResultModel<TResult> Exception<TResult>(this ResultModel<TResult> _, Exception ex, string message = "خطای سرور")
        {
            var error = new ErrorModel
            {
                Message = message
            };
            return ResultModel<TResult>.Fail(error);
        }

        public static ResultModel<TResult> Exception<TResult>(Exception ex, string message = "خطای سرور")
            => new ResultModel<TResult>().Exception(ex, message);
    }
