...
namespace CMS.Application.Blog.Validators
{
    public class CreateBlogPostCommandValidator : AbstractValidator<CreateBlogPostCommand>
    {
        ...
        public CreateBlogPostCommandValidator(IRepository<BlogPostTranslation> translationRepository, ITenantContext tenantContext)
        {
        ...
        private async Task<bool> BeUniqueSlug(CreateBlogPostCommand command, string slug, CancellationToken cancellationToken)
        {
