...
{
    public class CreateBlogPostTranslationCommandValidator : AbstractValidator<CreateBlogPostTranslationCommand>
    {
        private readonly IRepository<BlogPostTranslation> _translationRepository;
        private readonly ITenantContext _tenantContext;

        public CreateBlogPostTranslationCommandValidator(IRepository<BlogPostTranslation> translationRepository, ITenantContext tenantContext)
        {
        ...
        private async Task<bool> BeUniqueSlug(CreateBlogPostTranslationCommand command, string slug, CancellationToken cancellationToken)
        {
