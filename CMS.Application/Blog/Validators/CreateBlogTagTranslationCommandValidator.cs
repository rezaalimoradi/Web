...
{
    public class CreateBlogTagTranslationCommandValidator : AbstractValidator<CreateBlogTagTranslationCommand>
    {
        private readonly IRepository<BlogTagTranslation> _translationRepository;
        private readonly ITenantContext _tenantContext;

        public CreateBlogTagTranslationCommandValidator(IRepository<BlogTagTranslation> translationRepository, ITenantContext tenantContext)
        {
        ...
        private async Task<bool> BeUniqueSlug(CreateBlogTagTranslationCommand command, string slug, CancellationToken cancellationToken)
        {
