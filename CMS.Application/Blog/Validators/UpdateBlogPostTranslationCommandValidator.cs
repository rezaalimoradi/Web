...
{
    public class UpdateBlogPostTranslationCommandValidator : AbstractValidator<UpdateBlogPostTranslationCommand>
    {
        private readonly IRepository<BlogPostTranslation> _translationRepository;
        private readonly ITenantContext _tenantContext;

        public UpdateBlogPostTranslationCommandValidator(IRepository<BlogPostTranslation> translationRepository, ITenantContext tenantContext)
        {
        ...
        private async Task<bool> BeUniqueSlug(UpdateBlogPostTranslationCommand command, string slug, CancellationToken cancellationToken)
        {
