...
{
    public class UpdateProductAttributeTranslationCommandValidator : AbstractValidator<UpdateProductAttributeTranslationCommand>
    {
        public UpdateProductAttributeTranslationCommandValidator()
        {
