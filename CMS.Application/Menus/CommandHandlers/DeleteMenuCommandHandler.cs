...
{
    public class DeleteMenuCommandHandler : IAppRequestHandler<DeleteMenuCommand, ResultModel<long>>
    {
        ...
        public async Task<ResultModel<long>> Handle(DeleteMenuCommand request, CancellationToken cancellationToken)
        {
            try
            {
