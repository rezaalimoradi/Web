...
{
    public class UpdateMenuItemTranslationCommandHandler : IAppRequestHandler<UpdateMenuItemTranslationCommand, ResultModel<long>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly ITenantContext _tenantContext;

        public UpdateMenuItemTranslationCommandHandler(IUnitOfWork unitOfWork, ITenantContext tenantContext)
        {
            _unitOfWork = unitOfWork;
            _tenantContext = tenantContext;
        }

        public async Task<ResultModel<long>> Handle(UpdateMenuItemTranslationCommand request, CancellationToken cancellationToken)
        {
