...
{
    public class DeleteCartItemTranslationCommandValidator : AbstractValidator<DeleteCartItemTranslationCommand>
    {
        private readonly IRepository<CartItemTranslation> _translationRepository;
        private readonly ITenantContext _tenantContext;

        public DeleteCartItemTranslationCommandValidator(IRepository<CartItemTranslation> translationRepository, ITenantContext tenantContext)
        {
