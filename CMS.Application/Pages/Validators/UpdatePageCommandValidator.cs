...
namespace CMS.Application.Pages.Validators
{
    public class UpdatePageCommandValidator : AbstractValidator<UpdatePageCommand>
    {
        ...
        public UpdatePageCommandValidator(IRepository<PageTranslation> translationRepository, ITenantContext tenantContext)
        {
        ...
        private async Task<bool> BeUniqueSlug(UpdatePageCommand command, string slug, CancellationToken cancellationToken)
        {
